// GENERATED AUTOMATICALLY FROM 'Assets/ThirdPersonShooter/Input/ThirdPersonShooterInputAsset.inputactions'
...
public class @ThirdPersonShooterInputAsset : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @ThirdPersonShooterInputAsset()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ThirdPersonShooterInputAsset"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @ThirdPersonShooterInputAsset m_Wrapper;
        public PlayerActions(@ThirdPersonShooterInputAsset wrapper) { m_Wrapper = wrapper; }
